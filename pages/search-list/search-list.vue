<template>
	<view>
		...
		<view class=" d-flex a-center j-around px-2 pt-1 pb-0">
			...
			<i class="iconfont icon-tubiao- text-light-muted i-font-size"></i>
		</view>
		<!-- 排序|筛选 -->
		<view class="d-flex border-top border-bottom a-center position-fixed left-0 right-0 bg-white" style="height: 100upx;z-index: 100;">
